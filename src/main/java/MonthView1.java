...
//		}
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException{
        ...
        session.setAttribute("UserCalenderTable", sb.toString());

		// JSPへのフォワード
		RequestDispatcher rd = req.getRequestDispatcher("MonthView1.jsp");
		rd.forward(req, res);
    ...
    protected String createScheduleStr(int year, int month, int startDayNo, int[] calendarDay, int userid){
        ...
        for (int i = startDayNo ; i < startDayNo + 7 ; i++){
            if (calendarDay[i] > 35){
                ...
                sb.append("<a href=\"/scheduleMVC/NewSchedule");
                ...
                try {
                    ...
                    while(rs.next()){
                        ...
                        sb.append("<a href=\"/scheduleMVC/ScheduleView?ID=");
                        sb.append(id);
                        sb.append("\">");
                        sb.append(schedule);
                        sb.append("</a><br>");
    ...
    protected String createMonthLink(int year, int month){
        ...
        sb.append("<a href=\"/scheduleMVC/MonthView?YEAR=");
        sb.append(year);
        sb.append("&MONTH=");
        sb.append(month - 1);
